...
cl /D __WINDOWS %INCLUDES% kernel.obj NvOF.obj NvOFCuda.obj nv_opt_flow_lib.cpp /EHsc /LD %CUDAFLAGS% /link /DEBUG /DLL /LIBPATH:%CUDALIBS% /MACHINE:X64 /INCREMENTAL:NO cudart.lib cuda.lib /implib:nv_opt_flow_lib.lib /OUT:nv_opt_flow_lib.dll
